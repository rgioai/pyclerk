...
class CitationsEndpoint(Endpoint):
    def __init__(self, access_token: str = 'abcd12345', api_version: int = 1, body_format: str = 'text'):
        """
        Class for accessing the citations api endpoint.  Not yet implemented
        ...
        self.endpoint_url = self.base_url + 'citations'
        raise NotImplementedError('{} not implemented yet, sorry!'.format(type(self)))
    # FUTURE Add the CitationsEndpoint class
